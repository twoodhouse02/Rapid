...
(() => {
/*!********************************************!*\
  !*** ./src/blocks/floating-images/view.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
(0,motion__WEBPACK_IMPORTED_MODULE_1__.inView)(".wp-block-rapid-floating-images.animated", element => {
  const children = element.querySelectorAll(".floating-image");
  if (_assets_js_animation_utils__WEBPACK_IMPORTED_MODULE_0__.animationType === "fade-only") {
