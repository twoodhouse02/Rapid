...
/******/ 			return "" + chunkId + ".js?v=" + "f4c9ad28d9837222c382" + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
document.querySelectorAll(".gallery-preview").forEach(gallery => {
  ...
  if (gallery.hasAttribute("display-captions") && gallery.getAttribute("display-captions") === "true") {
    new photoswipe_dynamic_caption_plugin__WEBPACK_IMPORTED_MODULE_2__["default"](lightbox, {
      type: "auto"
    });
  }
  lightbox.init();
